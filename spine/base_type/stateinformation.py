...
class StateInformationDataType:
    def __init__(
            self,
            state_information_id: stateInformationIdType = None,
            state_information: FunctionType = None,
            is_active: bool = None,
            category: FunctionType = None,
            time_of_last_change: FunctionType = None,
    ):
        super().__init__()
        ...
        if not isinstance(self.state_information, FunctionType | NoneType):
            raise TypeError("state_information is not of type FunctionType")
        
        if not isinstance(self.is_active, bool | NoneType):
            raise TypeError("is_active is not of type bool")
        
        if not isinstance(self.category, FunctionType | NoneType):
            raise TypeError("category is not of type FunctionType")
        
        if not isinstance(self.time_of_last_change, FunctionType | NoneType):
            raise TypeError("time_of_last_change is not of type FunctionType")
...
class StateInformationListDataType:
    def __init__(
            self,
...
class StateInformationListDataSelectorsType:
    def __init__(
            self,
            state_information_id: stateInformationIdType = None,
            state_information: FunctionType = None,
...
class StateInformationDataElementsType:
    def __init__(
            self,
