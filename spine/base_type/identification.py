...
class SessionMeasurementRelationDataType:
    def __init__(
            self,
...
class SessionIdentificationDataType:
    def __init__(
            self,
            session_id: SessionIdType = None,
...
class IdentificationDataType:
    def __init__(
            self,
            identification_id: IdentificationIdType = None,
            identification_type: FunctionType = None,
        ...
        if not isinstance(self.identification_type, FunctionType | NoneType):
            raise TypeError("identification_type is not of type FunctionType")
...
class SessionMeasurementRelationListDataType:
    def __init__(
            self,
...
class SessionMeasurementRelationListDataSelectorsType:
    def __init__(
            self,
            session_id: SessionIdType = None,
...
class SessionMeasurementRelationDataElementsType:
    def __init__(
            self,
...
class SessionIdentificationListDataType:
    def __init__(
            self,
...
class SessionIdentificationListDataSelectorsType:
    def __init__(
            self,
            session_id: SessionIdType = None,
            identification_id: IdentificationIdType = None,
...
class SessionIdentificationDataElementsType:
    def __init__(
            self,
            session_id: ElementTagType = None,
...
class IdentificationListDataType:
    def __init__(
            self,
...
class IdentificationListDataSelectorsType:
    def __init__(
            self,
            identification_id: IdentificationIdType = None,
            identification_type: FunctionType = None,
...
class IdentificationDataElementsType:
    def __init__(
            self,
            identification_id: ElementTagType = None,
