...
class NetworkManagementFeatureDescriptionDataType:
    def __init__(
            self,
            feature_address: FeatureAddressType = None,
            feature_type: FunctionType = None,
            specific_usage: list[FunctionType] = None,
        ...
        if not isinstance(self.feature_type, FunctionType | NoneType):
            raise TypeError("feature_type is not of type FunctionType")
        
        if not isinstance(self.specific_usage, list | NoneType):
            raise TypeError("specific_usage is not of type list[FunctionType]")
...
class NetworkManagementEntityDescriptionDataType:
    def __init__(
            self,
            entity_address: EntityAddressType = None,
            entity_type: FunctionType = None,
            last_state_change: NetworkManagementStateChangeType = None,
            minimum_trust_level: NetworkManagementMinimumTrustLevelType = None,
            label: LabelType = None,
            description: DescriptionType = None,
        ...
        if not isinstance(self.entity_type, FunctionType | NoneType):
            raise TypeError("entity_type is not of type FunctionType")
...
class NetworkManagementDeviceDescriptionDataType:
    def __init__(
            self,
            device_address: DeviceAddressType = None,
            device_type: FunctionType = None,
        ...
        if not isinstance(self.device_type, FunctionType | NoneType):
            raise TypeError("device_type is not of type FunctionType")
...
class NetworkManagementScanNetworkCallType:
    def __init__(
            self,
...
class NetworkManagementScanNetworkCallElementsType:
    def __init__(
            self,
...
class NetworkManagementReportCandidateDataType:
    def __init__(
            self,
...
class NetworkManagementReportCandidateDataElementsType:
    def __init__(
            self,
...
class NetworkManagementRemoveNodeCallType:
    def __init__(
            self,
...
class NetworkManagementRemoveNodeCallElementsType:
    def __init__(
            self,
...
class NetworkManagementProcessStateDataType:
    def __init__(
            self,
...
class NetworkManagementProcessStateDataElementsType:
    def __init__(
            self,
...
class NetworkManagementModifyNodeCallType:
    def __init__(
            self,
            node_address: FeatureAddressType = None,
            native_setup: NetworkManagementNativeSetupType = None,
...
class NetworkManagementModifyNodeCallElementsType:
    def __init__(
            self,
            node_address: FeatureAddressElementsType = None,
...
class NetworkManagementJoiningModeDataType:
    def __init__(
            self,
...
class NetworkManagementJoiningModeDataElementsType:
    def __init__(
            self,
...
class NetworkManagementFeatureDescriptionListDataType:
    def __init__(
            self,
...
class NetworkManagementFeatureDescriptionListDataSelectorsType:
    def __init__(
            self,
            feature_address: FeatureAddressType = None,
            feature_type: FunctionType = None,
...
class NetworkManagementFeatureDescriptionDataElementsType:
    def __init__(
            self,
...
class NetworkManagementEntityDescriptionListDataType:
    def __init__(
            self,
...
class NetworkManagementEntityDescriptionListDataSelectorsType:
    def __init__(
            self,
            entity_address: EntityAddressType = None,
            entity_type: FunctionType = None,
...
class NetworkManagementEntityDescriptionDataElementsType:
    def __init__(
            self,
...
class NetworkManagementDiscoverCallType:
    def __init__(
            self,
...
class NetworkManagementDiscoverCallElementsType:
    def __init__(
            self,
...
class NetworkManagementDeviceDescriptionListDataType:
    def __init__(
            self,
...
class NetworkManagementDeviceDescriptionListDataSelectorsType:
    def __init__(
            self,
            device_address: DeviceAddressType = None,
            device_type: FunctionType = None,
...
class NetworkManagementDeviceDescriptionDataElementsType:
    def __init__(
            self,
...
class NetworkManagementAddNodeCallType:
    def __init__(
            self,
            node_address: FeatureAddressType = None,
            native_setup: NetworkManagementNativeSetupType = None,
...
class NetworkManagementAddNodeCallElementsType:
    def __init__(
            self,
            node_address: FeatureAddressElementsType = None,
            native_setup: ElementTagType = None,
...
class NetworkManagementAbortCallType:
    def __init__(
            self,
    ):
        super().__init__()
...
class NetworkManagementAbortCallElementsType:
    def __init__(
            self,
    ):
        super().__init__()
