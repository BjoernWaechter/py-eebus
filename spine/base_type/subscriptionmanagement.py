...
class SubscriptionManagementEntryDataType:
    def __init__(
            self,
...
class SubscriptionManagementRequestCallType:
    def __init__(
            self,
            client_address: FeatureAddressType = None,
            server_address: FeatureAddressType = None,
...
class SubscriptionManagementRequestCallElementsType:
    def __init__(
            self,
...
class SubscriptionManagementEntryListDataType:
    def __init__(
            self,
...
class SubscriptionManagementEntryListDataSelectorsType:
    def __init__(
            self,
            subscription_id: SubscriptionIdType = None,
            client_address: FeatureAddressType = None,
...
class SubscriptionManagementEntryDataElementsType:
    def __init__(
            self,
...
class SubscriptionManagementDeleteCallType:
    def __init__(
            self,
            subscription_id: SubscriptionIdType = None,
            client_address: FeatureAddressType = None,
...
class SubscriptionManagementDeleteCallElementsType:
    def __init__(
            self,
            subscription_id: ElementTagType = None,
            client_address: FeatureAddressElementsType = None,
