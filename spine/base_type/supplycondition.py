...
class SupplyConditionThresholdRelationDataType:
    def __init__(
            self,
...
class SupplyConditionDataType:
    def __init__(
        ...
        if not isinstance(self.event_type, FunctionType | NoneType):
            raise TypeError("event_type is not of type FunctionType")
        
        if not isinstance(self.originator, FunctionType | NoneType):
            raise TypeError("originator is not of type FunctionType")
        ...
        if not isinstance(self.grid_condition, FunctionType | NoneType):
            raise TypeError("grid_condition is not of type FunctionType")
...
class SupplyConditionDescriptionDataType:
    def __init__(
            self,
            condition_id: ConditionIdType = None,
...
class SupplyConditionThresholdRelationListDataType:
    def __init__(
            self,
...
class SupplyConditionThresholdRelationListDataSelectorsType:
    def __init__(
            self,
            condition_id: ConditionIdType = None,
            threshold_id: ThresholdIdType = None,
...
class SupplyConditionThresholdRelationDataElementsType:
    def __init__(
            self,
...
class SupplyConditionListDataType:
    def __init__(
            self,
...
class SupplyConditionListDataSelectorsType:
    def __init__(
            self,
            condition_id: ConditionIdType = None,
...
class SupplyConditionDescriptionListDataType:
    def __init__(
            self,
...
class SupplyConditionDescriptionListDataSelectorsType:
    def __init__(
            self,
            condition_id: ConditionIdType = None,
    ):
...
class SupplyConditionDescriptionDataElementsType:
    def __init__(
            self,
            condition_id: ElementTagType = None,
...
class SupplyConditionDataElementsType:
    def __init__(
            self,
            condition_id: ElementTagType = None,
