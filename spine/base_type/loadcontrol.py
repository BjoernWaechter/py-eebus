...
class LoadControlStateDataType:
    def __init__(
            self,
            timestamp: FunctionType = None,
            event_id: LoadControlEventIdType = None,
            event_state_consume: FunctionType = None,
            applied_event_action_consume: FunctionType = None,
            event_state_produce: FunctionType = None,
            applied_event_action_produce: FunctionType = None,
    ):
        super().__init__()
        ...
        if not isinstance(self.event_state_consume, FunctionType | NoneType):
            raise TypeError("event_state_consume is not of type FunctionType")
        
        if not isinstance(self.applied_event_action_consume, FunctionType | NoneType):
            raise TypeError("applied_event_action_consume is not of type FunctionType")
        
        if not isinstance(self.event_state_produce, FunctionType | NoneType):
            raise TypeError("event_state_produce is not of type FunctionType")
        
        if not isinstance(self.applied_event_action_produce, FunctionType | NoneType):
            raise TypeError("applied_event_action_produce is not of type FunctionType")
...
class LoadControlLimitDataType:
    def __init__(
            self,
...
class LoadControlLimitDescriptionDataType:
    def __init__(
            self,
            limit_id: LoadControlLimitIdType = None,
            limit_type: FunctionType = None,
            limit_category: FunctionType = None,
            limit_direction: FunctionType = None,
        ...
        if not isinstance(self.limit_type, FunctionType | NoneType):
            raise TypeError("limit_type is not of type FunctionType")
        
        if not isinstance(self.limit_category, FunctionType | NoneType):
            raise TypeError("limit_category is not of type FunctionType")
        
        if not isinstance(self.limit_direction, FunctionType | NoneType):
            raise TypeError("limit_direction is not of type FunctionType")
...
class LoadControlLimitConstraintsDataType:
    def __init__(
            self,
            limit_id: LoadControlLimitIdType = None,
...
class LoadControlEventDataType:
    def __init__(
            self,
            timestamp: FunctionType = None,
            event_id: LoadControlEventIdType = None,
            event_action_consume: FunctionType = None,
            event_action_produce: FunctionType = None,
            time_period: TimePeriodType = None,
    ):
        super().__init__()
        ...
        if not isinstance(self.event_action_consume, FunctionType | NoneType):
            raise TypeError("event_action_consume is not of type FunctionType")
        
        if not isinstance(self.event_action_produce, FunctionType | NoneType):
            raise TypeError("event_action_produce is not of type FunctionType")
...
class LoadControlStateListDataType:
    def __init__(
            self,
...
class LoadControlStateListDataSelectorsType:
    def __init__(
            self,
...
class LoadControlStateDataElementsType:
    def __init__(
            self,
...
class LoadControlNodeDataElementsType:
    def __init__(
            self,
...
class LoadControlLimitListDataType:
    def __init__(
            self,
...
class LoadControlLimitListDataSelectorsType:
    def __init__(
            self,
            limit_id: LoadControlLimitIdType = None,
    ):
...
class LoadControlLimitDescriptionListDataType:
    def __init__(
            self,
...
class LoadControlLimitDescriptionListDataSelectorsType:
    def __init__(
            self,
            limit_id: LoadControlLimitIdType = None,
            limit_type: FunctionType = None,
...
class LoadControlLimitDescriptionDataElementsType:
    def __init__(
            self,
...
class LoadControlLimitDataElementsType:
    def __init__(
            self,
            limit_id: ElementTagType = None,
...
class LoadControlLimitConstraintsListDataType:
    def __init__(
            self,
...
class LoadControlLimitConstraintsListDataSelectorsType:
    def __init__(
            self,
            limit_id: LoadControlLimitIdType = None,
    ):
...
class LoadControlLimitConstraintsDataElementsType:
    def __init__(
            self,
            limit_id: ElementTagType = None,
...
class LoadControlEventListDataType:
    def __init__(
            self,
...
class LoadControlEventListDataSelectorsType:
    def __init__(
            self,
            timestamp_interval: TimestampIntervalType = None,
            event_id: LoadControlEventIdType = None,
...
class LoadControlEventDataElementsType:
    def __init__(
            self,
            timestamp: ElementTagType = None,
            event_id: ElementTagType = None,
