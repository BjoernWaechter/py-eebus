...
class AccessMethodsType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            ...
            return cls(
                id=data_dict.get('id'), 
                dns_sd_m_dns=DnsSd_MDns.from_data(data_dict.get('dnsSd_mDns')), 
                dns=Dns.from_data(data_dict.get('dns')), 
            )
        elif data:
            return cls(data)
        else:
...
class ConnectionCloseType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            data_dict = array_2_dict(data)
            return cls(
                phase=ConnectionClosePhaseType(data_dict.get('phase')), 
                max_time=data_dict.get('maxTime'), 
                reason=ConnectionCloseReasonType(data_dict.get('reason')), 
            )
        elif data:
            return cls(data)
        else:
...
class DataType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            data_dict = array_2_dict(data)
            return cls(
                header=HeaderType.from_data(data_dict.get('header')), 
                payload=data_dict.get('payload'), 
                extension=ExtensionType.from_data(data_dict.get('extension')), 
            )
        elif data:
            return cls(data)
        else:
...
class ConnectionPinErrorType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            data_dict = array_2_dict(data)
            return cls(
                error=ConnectionPinErrorErrorType.from_data(data_dict.get('error')), 
            )
        elif data:
            return cls(data)
        else:
...
class ConnectionPinInputType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            data_dict = array_2_dict(data)
            return cls(
                pin=PinValueType.from_data(data_dict.get('pin')), 
            )
        elif data:
            return cls(data)
        else:
...
class ConnectionPinStateType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            data_dict = array_2_dict(data)
            return cls(
                pin_state=PinStateType(data_dict.get('pinState')), 
                input_permission=PinInputPermissionType(data_dict.get('inputPermission')), 
            )
        elif data:
            return cls(data)
        else:
...
class MessageProtocolHandshakeErrorType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            data_dict = array_2_dict(data)
            return cls(
                error=MessageProtocolHandshakeErrorErrorType.from_data(data_dict.get('error')), 
            )
        elif data:
            return cls(data)
        else:
...
class MessageProtocolHandshakeType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            data_dict = array_2_dict(data)
            return cls(
                handshake_type=ProtocolHandshakeTypeType(data_dict.get('handshakeType')), 
                version=Version.from_data(data_dict.get('version')), 
                formats=MessageProtocolFormatsType.from_data(data_dict.get('formats')), 
            )
        elif data:
            return cls(data)
        else:
...
class ConnectionHelloType(ShipMessageType):
    ...
    def from_data(cls, data):
        if type(data) == list:
            data_dict = array_2_dict(data)
            return cls(
                phase=ConnectionHelloPhaseType(data_dict.get('phase')), 
